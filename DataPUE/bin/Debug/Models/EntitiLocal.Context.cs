...
namespace DataPUE.Models
{
    ...
    public partial class EntitieLocal : DbContext
    {
        public EntitieLocal()
            : base("name=EntitieLocal")
        {
        }
        ...
        public DbSet<DESCRIPCION_DESCUENTO> DESCRIPCION_DESCUENTO { get; set; }
        public DbSet<INVENTARIO> INVENTARIO { get; set; }
        public DbSet<PARAMETROS> PARAMETROS { get; set; }
        public DbSet<DEDOS_AMP> DEDOS_AMP { get; set; }
        public DbSet<DEDOS_CAUSA> DEDOS_CAUSA { get; set; }
        public DbSet<VERSIONAMIENTO> VERSIONAMIENTO { get; set; }
    }
}
