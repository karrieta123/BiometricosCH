...
namespace EDSDKWrapper.Framework.Invokes
{
    ...
    public static class EDSDKInvokes
    {
        ...
        public extern static UInt32 Download(IntPtr inDirItemRef, UInt64 inReadSize, IntPtr outStream);
        ...
        /// <returns>Any of the <see cref="ReturnValue"/> return values.</returns>
        /// <remarks></remarks>
        [DllImport("EDSDK.dll", EntryPoint = "EdsCreateMemoryStream", CallingConvention = CallingConvention.Winapi)]
        public extern static UInt64 CreateMemoryStream(UInt64 inBufferSize, out IntPtr outStream);
        ...
        public extern static UInt32 Read(IntPtr inStreamRef, UInt64 inReadSize, IntPtr outBuffer,
        ...
        public extern static UInt32 Write(IntPtr inStreamRef, UInt64 inWriteSize, IntPtr inBuffer,
        ...
        public extern static UInt32 GetPosition(IntPtr inStreamRef, out UInt64 outPosition);
        ...
        public extern static UInt32 GetLength(IntPtr inStreamRef, out UInt64 outLength);
        ...
        public extern static UInt32 CopyData(IntPtr inStreamRef, UInt64 inWriteSize, IntPtr outStreamRef);
